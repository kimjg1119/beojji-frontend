...
import { apiMySubmission } from "@/lib/api";

export default function MySubmissionPage() {
  const submissions = use(apiMySubmission({})).data;
            ...
            {submissions.map((submission) => (
              ...
              >
                ...
                <td className="px-4 py-2 text-center">
                  코스id{/* {submission.courseProblem.course.courseId} */}
                </td>
                <td className="px-4 py-2 text-center">
                  <Link
                  ...
                  >
                    타이틀{/* {submission.courseProblem.problem.title} */}
                  </Link>
                </td>
                <td className="px-4 py-2 text-center">
                  <Link
