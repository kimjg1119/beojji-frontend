...
import { HiChartPie, HiViewBoards, HiInbox, HiUser, HiChartBar, HiCog } from 'react-icons/hi';
...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ setActivePage, activePage }) => {
  const sidebarItems = [
